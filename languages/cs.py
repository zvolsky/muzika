...
'Ambiguous candidate user, choose one from the hint.': 'Ambiguous candidate user, choose one from the hint.',
'Ambiguous candidate user.': 'Ambiguous candidate user.',
...
'Click group name to manage group members.': 'Click group name to manage group members.',
...
'Find and add user': 'Find and add user',
...
'Modules': 'Moduly',
'modules': 'moduly',
'Muzikanti (uživatelé)': 'Muzikanti (uživatelé)',
'My Sites': 'Správa aplikací',
'Místa': 'Místa',
'Můj rozpis': 'Můj rozpis',
'Name': 'Jméno',
...
'No groups defined yet.': 'No groups defined yet.',
...
'Práva uživatelů': 'Práva uživatelů',
'Python': 'Python',
...
'To create new group, please navigate to <app>/plugin_manage_groups/group/<new_group_name>.': 'To create new group, please navigate to <app>/plugin_manage_groups/group/<new_group_name>.',
...
'use syntax: plugin_manage_groups/group/<groupname> --or-- set ADMIN_GROUP in models/plugin_manage_groups_sure_admin': 'use syntax: plugin_manage_groups/group/<groupname> --or-- set ADMIN_GROUP in models/plugin_manage_groups_sure_admin',
...
'Users not in group': 'Users not in group',
'variables': 'variables',
